...
| `gemini` | Flash: 1,500 RPD; Gemma 4: 30 RPM | Flash: 15 RPM / 1M TPM | [ai.google.dev/pricing](https://ai.google.dev/pricing) |
...
Most generous free tier among major providers. `google-genai` SDK (not OpenAI-compatible base; [compatibility layer available](https://ai.google.dev/gemini-api/docs/openai)). · 🧠 ✅ · 👁️ ✅ · 🔧 ✅ · 📡 ✅
...
- **Free tier** — permanent, no CC, no expiration. Google may use free-tier requests for model improvement.
  ...
  | `gemini-2.5-pro` | 5 | 50 (trial only) | 1M |
  | `gemma-4-31b-it` | 30 | 1,500 | 1M |
  | `gemma-4-26b-a4b-it` (MoE 3.8B active) | 30 | 1,500 | 1M |
