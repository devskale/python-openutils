    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Response: {response.text[:200]}...") # Truncate for brevity
             ...
             print("SUCCESS (Validation): Proxy accepted structured content (Provider auth failed as expected).")
...
if __name__ == "__main__":
    ...
    test_proxy_model("bigmodel@glm-4.5-flash", token="test23@test34")
