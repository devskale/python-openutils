    ...
    def complete(
        ...
        **provider_specific_kwargs
        ...
        try:
            ...
            response_body = getattr(e, 'response', None) # AI21 errors might have a 'response' attribute
            mapped_error = map_provider_error("ai21", e, status_code=status_code, response_body=response_body)
            raise mapped_error
    ...
    def stream_complete(
        ...
        **provider_specific_kwargs
        ...
        try:
            ...
            raise map_provider_error("AI21", e, status_code=status_code, response_body=response_body)
